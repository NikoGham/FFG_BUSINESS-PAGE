		...
		<Router>
			<div id='st-container' className='st-container'>
				<nav className='st-menu st-effect-1' id='menu-1'>
					<ul>
						<li onclick='showHeader()' id='headerclick'>
							{/* Generator: Adobe Illustrator 18.1.1, SVG Export Plug-In . SVG Version: 6.00 Build 0)  */}
							<svg
								className='menuHomeSVG'
								version='1.1'
								id='Capa_1'
								...
								x='0px'
								y='0px'
								viewBox='0 0 49.164 49.164'
								style={{ enableBackground: 'new 0 0 49.164 49.164' }}
								xmlSpace='preserve'
							>
								<g>
									<path
										style={{ fill: '#1D1C1A' }}
										d='M49.151,5.304c-0.029-0.013-0.097,0.018-0.229,0.106c-0.892,0.594-4.431,1.993-9.317,3.089
            ...
            s-0.628-0.499-0.646-1.051l-0.138-4.274C35.639,32.698,36.025,32.216,36.518,32.174z'
						...
						<Link to='/Creed' onClick={toggleMenu} id='aboutclick'>
							<svg
								className='menuHomeSVGsub'
								version='1.1'
								id='Capa_1'
								xmlns='http://www.w3.org/2000/svg'
								xmlnsXlink='http://www.w3.org/1999/xlink'
								x='0px'
								y='0px'
								viewBox='0 0 41.403 41.403'
								style={{ enableBackground: 'new 0 0 41.403 41.403' }}
								xmlSpace='preserve'
							>
								<g>
									<g>
										<path
											style={{ fill: '#06090f' }}
											d='M36.932,21.36c-0.438-0.292-0.868-0.552-1.285-0.786c-0.727-0.407-1.355-0.679-1.377-0.666
           ...
           c-0.116-0.285,0.435-0.728,1.152-1.076c0.717-0.348,1.369-0.485,1.537-0.23C3.595,20.099,3.177,20.678,2.407,21.056z'
										...
										<path
											style={{ fill: '#06090f' }}
											d='M22.243,12.275c-0.632,0-1.876,1.321-1.876,2.951c0,0.14,0.005,0.276,0.013,0.409
           ...
           c-0.261,0-0.473-0.301-0.473-0.673s0.212-0.673,0.473-0.673h1.299C23.954,13.08,24.167,13.381,24.167,13.752z'
										...
										<path
											style={{ fill: '#06090f' }}
											d='M7.98,14.36c0.036,0.301,0.126,0.585,0.225,0.862c0.363,1.117,0.986,2.049,1.692,2.767
           ...
           c-0.033,0.175-0.062,0.349-0.089,0.522c-0.045,0.288-0.071,0.691-0.068,0.899l0.005,0.377C7.851,13.829,7.943,14.031,7.98,14.36z'
						...
						<Link to='/Membership' id='memclick'>
							<i className='fas fa-key' /> Membership
						</Link>
						<li onclick='showTimetable()' id='timeclick'>
							<i className='far fa-calendar-alt' /> Timetable
						</li>
						<li onclick='showContact()' id='contclick'>
							<i className='far fa-envelope' /> Contact
						</li>
						<li onclick='showMerch()' id='merchclick'>
							<i className='fas fa-socks' /> Merch
						</li>
						<li id='merchclick'>
							<i className='far fa-id-badge' />Athletes (coming soon)
						</li>
						<li id='merchclick'>
							<i className='fab fa-hubspot' />Affiliates (coming soon)
						</li>
					</ul>
				</nav>
					...
					<div className='st-content'>
						...
						<div className='st-content-inner'>
							...
							<div id='st-trigger-effects'>
								{/* <button data-effect="st-effect-13" class="">Fall down</button> */}
								<button
									onClick={toggleMenu}
									style={{ outline: 'none' }}
